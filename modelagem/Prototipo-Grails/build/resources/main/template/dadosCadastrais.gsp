                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <asset:image src="user.png" class="img-responsive avatar-view" alt="Avatar"/>
                                </div>
                            </div>
                            ...
                            <ul class="list-unstyled user_data">
                                <li>
                                    <i class="fa fa-archive"></i> N° Cadastro: ${NCadastro}
                                </li>

                                <li><i class="fa fa-folder-open"></i> N° Prontuário: ${NProntuario}
                                </li>
