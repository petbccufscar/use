...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Nome do Professor (??)<small></small></h2>
                    %{--<ul class="nav navbar-right panel_toolbox">--}%
                        %{--<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>--}%
                        %{--</li>--}%
                        %{--<li class="dropdown">--}%
                            %{--<a href="https://colorlib.com/polygon/gentelella/form.html#" class="dropdown-toggle"--}%
                               %{--data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i>--}%
                            %{--</a>--}%
                            %{--<ul class="dropdown-menu" role="menu">--}%
                                %{--<li><a href="https://colorlib.com/polygon/gentelella/form.html#">Settings 1</a>--}%
                                %{--</li>--}%
                                %{--<li><a href="https://colorlib.com/polygon/gentelella/form.html#">Settings 2</a>--}%
                                %{--</li>--}%
                            %{--</ul>--}%
                        %{--</li>--}%
                ...
                <div class="x_content">
                    ...
                    <form id="demo-form3" data-parsley-validate="" class="form-horizontal form-label-left"
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success">Visualizar/Corrigir</button>
                        </div>
                        <!-- Resumo e Data -->
                        <div class="form-group">
