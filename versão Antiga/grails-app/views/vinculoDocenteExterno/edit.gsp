...
<body>
	...
	<section id="edit-vinculoDocenteExterno" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${vinculoDocenteExternoInstance?.id}" />
			<g:hiddenField name="version" value="${vinculoDocenteExternoInstance?.version}" />
