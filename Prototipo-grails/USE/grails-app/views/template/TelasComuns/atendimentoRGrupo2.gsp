    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Realizar Atendimento em Grupo</h2>
                    ...
                    <div class="x_content">
                                                ...
                                                <div class="x_panel">
                                                    ...
                                                    <div class="col-md-2 col-sm-2 col-xs-2 form-group">
                                                        <div class="">
                                                            ...
                                                            <input type="text" id=""  placeholder="10/10/2016" class="form-control">
                                                        </div>
                                                ...
                                                <div class="x_panel">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                        <div class="">
                                                            ...
                                                            <input type="text" id=""  placeholder="Resumo" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                        <div class="">
                                                            ...
                                                            <input type="text" id=""  placeholder="Descrição" class="form-control" style="height: 100px;">
                                                        </div>
                                                    </div>
                                            ...
                                            <form data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="panel">
                                                            <div class="ln_solid"></div>
                                                            <a class="panel-heading collapsed" role="tab" id="headingUserTwo" data-toggle="collapse" data-parent="#accordion1" href="#collapseUserTwo" aria-expanded="false" aria-controls="collapseUserTwo">
                                                                <h5>Busca de Questionários</h5>
                                                            </a>
                                            ...
                                            <form data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="panel">
                                                            <div class="ln_solid"></div>
                                                            <a class="panel-heading collapsed" role="tab" id="headingUserOne" data-toggle="collapse" data-parent="#accordion" href="#collapseUserOne" aria-expanded="false" aria-controls="collapseUserOne">
                                                                <h5>Busca de Questionários</h5>
                                                            </a>
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <div class="">
                                <a class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Salvar</a>
                            </div>
                        </div>

                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <div class="">
                                <a class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Cancelar</a>
                            </div>
                        </div>
                    </div>
                    <!-- end of accordion -->
